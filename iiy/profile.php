...
$sql8="Select DISTINCT DATE from stu_daily_marks WHERE CID=$admincls  order by ID DESC";
...
//monthly tuition fee
if($feewithvan_quarterly==1){
$sql2="Select * from pcsmnth where YR2 !='' order by ID ASC";
$yr0='YR2';
}else{
$sql2="Select * from pcsmnth order by ID ASC";
$yr0='YR';
}
    	foreach ($dbh->query($sql2) as $row2)
        	{
			...
			$found=1;
			$tab6.='<tr><TD>';
			$tf=findnm("reg","TF"," WHERE ID=".$stuid."",$dbh);
