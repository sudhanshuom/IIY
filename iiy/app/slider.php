<?php $user=$_REQUEST['asd'];
include("college_app/conn.php");
?>
<!DOCTYPE html>
...
$sql="Select * from mainslider order by ID DESC";
    	...
    	foreach ($dbh->query($sql) as $row) 
        	{
$L='https://aoujiedu.app/erp/gallery/'.$login_name.'/'.$row['IMAGE'];
           echo '<div>
                <img data-u="image" src="'.$L.'" />';
           echo '<img data-u="thumb" src="https://aoujiedu.app/erp/gallery/'.$login_name.'/'.$row['IMAGE'].'" />';
