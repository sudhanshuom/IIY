     ...
     <br>
      <div class="container">
       ...
       <div class="row">
		...
		$subnm=findnm("stu_info","NM"," WHERE ID=$subid",$dbh); 
        ...
        <div class="col-xs-6">
               ...
               <p style="text-align:center; font-weight:bold;color: #ff5722;">Student</p>
				...
				<?php
						createoptions("stu_info WHERE CLS in(".$classids.")  ","ID","NM",$subid,$dbh)
...
<form method="POST" action="save_chat.php" enctype="multipart/form-data">
...
?>
 ...
 $sql = "Select * from stu_chat WHERE CID='$subid' AND TID='$stuid' order by ID ASC";
  		foreach ($dbh->query($sql) as $row)
			{
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
 ...
 <script> 
	...
	$.ajax({
		...
		cache:false,
			success:function(output){
				window.open("./chat.php?ses="+ses+"&stuid="+stuid+"&ps="+ps+"&classid="+classid+"&subid="+output,"_self")
	...
	$.ajax({
		...
		cache:false,
			success:function(output){
				window.open("./chat.php?ses="+ses+"&stuid="+stuid+"&ps="+ps+"&classid="+output,"_self")
			//	window.location.reload();
			}
