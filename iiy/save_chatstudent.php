...
if($eid=="")
{
	$dbh->exec("INSERT INTO stu_chat(DATE,CID,TID,MSG,BY1) VALUES ('$dt','$stuid','$subid','$cmt','CID')");
}
}
	header("location:./chatstudent.php?ses=".$ses."&stuid=".$stuid."&ps=".$ps."&classid=".$classid."&subid=".$subid);
	exit;
}
	header("location:./");
	exit;
