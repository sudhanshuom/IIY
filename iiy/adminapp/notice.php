...
<div class="wrapper">
   ...
   <br>
   <?php
    $sql = "Select * from stu_news order by DATE1 DESC";
    ...
    <div class="row" >
          ...
          <div  class="col-xs-12" style=" font-size:11px;">
              ...
              <div style="text-align:left; font-size:18px; font-weight:bold;color: #ff5722;"><?php echo $row['TTL']; ?></div>
              <div style="font-size:14px; "> <?php echo $row['DETAIL']; ?>
     	 <br>Posted Date: <?php echo date("d-m-Y",strtotime($row['DATE1'])); ?></div>
